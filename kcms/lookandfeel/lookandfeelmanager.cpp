...
void LookAndFeelManager::setColors(const QString &scheme, const QString &colorFile)
{
    ...
    auto set = [kdeGlobalsCfg]() {
        kdeGlobalsCfg->group("General").writeEntry("AccentColor", QColor());
        kdeGlobalsCfg->group("General").deleteEntry("AccentColor", KConfig::Notify);
    };
...
void LookAndFeelManager::revertKeyIfNeeded(KConfigGroup &group, KConfigGroup &home, KConfigGroup &defaults)
{
