...
private:
    ...
    bool m_applyColors = true;
    bool m_applyWidgetStyle = true;
    bool m_applyIcons = true;
    bool m_applyPlasmaTheme = true;
    bool m_applyCursors = true;
    bool m_applyWindowSwitcher = true;
    bool m_applyDesktopSwitcher = true;
    bool m_applyWindowPlacement = true;
    bool m_applyShellPackage = true;
    bool m_resetDefaultLayout = true;
    bool m_applyWindowDecoration = true;
